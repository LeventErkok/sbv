...
data SMTConfig = SMTConfig {
       ...
       , allSatMaxModelCount :: Maybe Int      -- ^ In an 'Data.SBV.allSat' call, return at most this many models. If nothing, return all.
       , allSatPrintAlong    :: Bool           -- ^ In an 'Data.SBV.allSat' call, print models as they are found.
