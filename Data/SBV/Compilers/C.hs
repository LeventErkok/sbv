...
-- | Write the contents of a C-program generated by 'compileToC' to disk. The argument is the directory
-- name under which the files will be saved. (To save files in the current directory, just pass the string @\".\"@.)
renderC :: FilePath -> CgPgmBundle -> IO ()
renderC = renderCgPgmBundle
