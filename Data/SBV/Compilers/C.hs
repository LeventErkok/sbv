...
genCProg cfg fn proto (Result kindInfo _tvals cgs ins preConsts tbls arrs _uis _axioms (SBVPgm asgns) cstrs _tacs _opts _goals origAsserts _) inVars outVars mbRet extDecls
