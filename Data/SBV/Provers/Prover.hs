...
simulate converter config isSat comments predicate = do
        ...
        case res of
          Result hasInfPrec is consts tbls arrs uis axs pgm [o@(SW (False, Size (Just 1)) _)] ->
          ...
          Result _hasInfPrec _is _consts _tbls _arrs _uis _axs _pgm os -> case length os of
