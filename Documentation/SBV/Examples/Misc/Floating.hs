...
-- Falsifiable. Counter-example:
--   x =      511.9866 :: Float
--   y = -2.4411366e-4 :: Float
--   z =     1.5625e-2 :: Float
--
-- Indeed, we have:
--
-- >>> let x =      511.9866 :: Float
-- >>> let y = -2.4411366e-4 :: Float
-- >>> let z =     1.5625e-2 :: Float
-- >>> x + (y + z)
-- 512.002
-- >>> (x + y) + z
-- 512.00195
...
-- >>> multInverse
-- Falsifiable. Counter-example:
--   a = -3.205670716941697e-289 :: Double
--
-- Indeed, we have:
--
-- >>> let a = -3.205670716941697e-289 :: Double
-- >>> a * (1/a)
-- 0.9999999999999999
