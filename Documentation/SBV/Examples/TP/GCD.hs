...
nGCD = smtRecFunction "nGCD" (\_ b -> b) $ \a b -> ite (b .== 0) a (nGCD b (a `sEMod` b))
...
nGCDSub = smtRecFunction "nGCDSub" (\a b -> a + b) $ \a b -> ite (a .== b) a
                                        $ ite (a .== 0) b
                                        $ ite (b .== 0) a
...
nGCDBin = smtRecFunction "nGCDBin" (\a b -> a + b) $ \a b -> ite (a .== 0)               b
                                        $ ite (b .== 0)               a
