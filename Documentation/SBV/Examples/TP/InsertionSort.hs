...
insert = smtFunction "insert" (withMeasure $ \_ l -> length l)
       $ \e l -> [sCase| l of
                     []               -> [e]
                     x : xs | e .<= x -> e .: x .: xs
                            | True    -> x .: insert e xs
...
insertionSort = smtFunction "insertionSort" (withMeasure length)
              $ \l -> [sCase| l of
                          []     -> []
...
removeFirst = smtFunction "removeFirst" (withMeasure $ \_ l -> length l)
            $ \e l -> [sCase| l of
                          []               -> []
                          x : xs | e .== x -> xs
...
isPermutation = smtFunction "isPermutation" (withMeasure $ \l _ -> length l)
              $ \l r -> [sCase| l of
                            []     -> null r
