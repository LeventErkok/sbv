...
sha256 :: SHA (SWord 32)
sha256 = sha224 { h0 = [ 0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a
...
sha512 :: SHA (SWord 64)
sha512 = sha384 { h0 = [ 0x6a09e667f3bcc908, 0xbb67ae8584caa73b, 0x3c6ef372fe94f82b, 0xa54ff53a5f1d36f1
                       , 0x510e527fade682d1, 0x9b05688c2b3e6c1f, 0x1f83d9abfb41bd6b, 0x5be0cd19137e2179
                       ]
                }

-- | Parameterization for SHA512_224. Inherits mostly from SHA512
sha512_224 :: SHA (SWord 64)
sha512_224 = sha512 { h0 = [ 0x8C3D37C819544DA2, 0x73E1996689DCD4D6, 0x1DFAB7AE32FF9C82, 0x679DD514582F9FCF
                           , 0x0F6D2B697BD44DA8, 0x77E36F7304C48942, 0x3F9D85A86A1D36C8, 0x1112E6AD91D692A1
                           ]
                     }

-- | Parameterization for SHA512_256. Inherits mostly from SHA512
sha512_256 :: SHA (SWord 64)
sha512_256 = sha512 { h0 = [ 0x22312194FC2BF72C, 0x9F555FA3C84C64C2, 0x2393B86B6F53B151, 0x963877195940EABD
...
-- corresponds to body of the for-loop in the spec.
...
-- | Compute the hash of a given string using the specified hash algorithm
sha :: (Num w, Bits w, ByteConverter w) => SHA w -> String -> [w]
sha p@SHA{h0} = foldl (hashBlock p) h0 . prepareMessage p
...
knownAnswerTests = and [showHash (sha sha256 t) == r | (t, r) <- sha256Kats]
  where -- From: https://github.com/bcgit/bc-java/blob/master/core/src/test/java/org/bouncycastle/crypto/test/SHA256DigestTest.java
...
showHash :: (SymVal a, Integral a, Show a) => [SBV a] -> String
showHash = concatMap cvt
  where cvt x  = case unliteral x of
                   Nothing -> error "Impossible happened: Non-concrete sha value!"
                   Just v  -> pad8 $ showHex v ""
