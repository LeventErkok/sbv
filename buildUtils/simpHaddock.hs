...
sbvIgnore input = any (`isPrefixOf` s) (map fmt patterns)
  where s     = dropWhile isSpace input
        ...
        patterns = [ "Core.Kind.BVZeroWidth"
                   ...
                   , "Tools.KnuckleDragger.KnuckleDragger.ChainStep"
                   , "Tools.KnuckleDragger.KnuckleDragger.ChainsTo"
                   , "Tools.KnuckleDragger.KnuckleDragger.HintsTo"
                   , "Tools.KnuckleDragger.KnuckleDragger.Hinted"
                   , "Tools.KnuckleDragger.KnuckleDragger.KDProof"
                   , "Tools.KnuckleDragger.KnuckleDragger.ProofHint"
                   , "Tools.KnuckleDragger.KnuckleDragger.ProofStep"
                   , "Tools.KnuckleDragger.KnuckleDragger.Trivial"
                   , "Tools.KnuckleDragger.KnuckleDragger.Helper"
                   , "Tools.KnuckleDragger.KnuckleDragger.Instantiatable"
                   , "Tools.KnuckleDragger.KnuckleDragger.Inductive"
                   , "Tools.KnuckleDragger.KnuckleDragger.SInductive"
                   , "Tools.KnuckleDragger.KnuckleDragger.CalcLemma"
                   , "Tools.KnuckleDragger.KnuckleDragger.Contradiction"
