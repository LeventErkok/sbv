...
sbvIgnore input = any (`isPrefixOf` s) (map fmt patterns)
  where s     = dropWhile isSpace input
        ...
        patterns = [ "Core.Kind.BVZeroWidth"
                   ...
                   , "Tools.TP.TP.ChainStep"
                   , "Tools.TP.TP.ChainsTo"
                   , "Tools.TP.TP.HintsTo"
                   , "Tools.TP.TP.Hinted"
                   , "Tools.TP.TP.TPProof"
                   , "Tools.TP.TP.ProofHint"
                   , "Tools.TP.TP.ProofStep"
                   , "Tools.TP.TP.Trivial"
                   , "Tools.TP.TP.Helper"
                   , "Tools.TP.TP.Instantiatable"
                   , "Tools.TP.TP.Inductive"
                   , "Tools.TP.TP.SInductive"
                   , "Tools.TP.TP.CalcLemma"
                   , "Tools.TP.TP.Contradiction"
