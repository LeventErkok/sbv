...
tests :: TestTree
tests =
  testGroup "Overflows" [ testGroup "add-uf" [ testCase "w8"  $ assertIsThm $ underflow   svPlus  (bvAddO :: SWord8  -> SWord8  -> (SBool, SBool))
                        ...
                        , testGroup "mul-uf" [ testCase "w8"  $ assertIsThm $ underflow   svTimes (bvMulO :: SWord8  -> SWord8  -> (SBool, SBool))
                                             ...
                                             , testCase "i8"  $ assertIsThm $ underflow   svTimes (bvMulO :: SInt8   -> SInt8   -> (SBool, SBool))
                                             , testCase "i16" $ assertIsThm $ underflow   svTimes (bvMulO :: SInt16  -> SInt16  -> (SBool, SBool))
                                             , testCase "i32" $ assertIsThm $ underflow   svTimes (bvMulO :: SInt32  -> SInt32  -> (SBool, SBool))
                                             , testCase "i64" $ assertIsThm $ underflow   svTimes (bvMulO :: SInt64  -> SInt64  -> (SBool, SBool))
                                             ]
                        , testGroup "mul-of" [ testCase "w8"  $ assertIsThm $ overflow    svTimes (bvMulO :: SWord8  -> SWord8  -> (SBool, SBool))
                                             , testCase "w16" $ assertIsThm $ overflow    svTimes (bvMulO :: SWord16 -> SWord16 -> (SBool, SBool))
                                             , testCase "w32" $ assertIsThm $ overflow    svTimes (bvMulO :: SWord32 -> SWord32 -> (SBool, SBool))
                                             , testCase "w64" $ assertIsThm $ overflow    svTimes (bvMulO :: SWord64 -> SWord64 -> (SBool, SBool))
                                             , testCase "i8"  $ assertIsThm $ overflow    svTimes (bvMulO :: SInt8   -> SInt8   -> (SBool, SBool))
                                             , testCase "i16" $ assertIsThm $ overflow    svTimes (bvMulO :: SInt16  -> SInt16  -> (SBool, SBool))
                                             , testCase "i32" $ assertIsThm $ overflow    svTimes (bvMulO :: SInt32  -> SInt32  -> (SBool, SBool))
                                             , testCase "i64" $ assertIsThm $ overflow    svTimes (bvMulO :: SInt64  -> SInt64  -> (SBool, SBool))
                                             ]
